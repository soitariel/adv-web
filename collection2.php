...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="kid50.jpg" alt="" style="width:100%">
      <div class="container">
        <h2>Jungle</h2>
        <p class="title">Dress</p>
        <p>Girls</p>
        <p>Mixed pink</p>
        <p>Price: From Kshs 1200</p>
  ...
  <div class="column">
    <div class="card">
      <img src="kids3.jpg" alt="Mike" style="width:100%">
      <div class="container">
        <h2>Casual</h2>
        <p class="title">Dress</p>
        <p>Girls</p>
        <p>purple</p>
        <p>Price: From Kshs 2000</p>
  ...
  <div class="column">
    <div class="card">
      <img src="kid59.jpg" alt="" style="width:100%">
      <div class="container">
        <h2>Dangaree</h2>
        <p class="title">Dress</p>
        <p>Girls</p>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="kids56.jpg" alt="Jane" style="width:100%">
      <div class="container">
        <h2>Nova</h2>
  ...
  <div class="column">
    <div class="card">
      <img src="kids60.jpg" alt="Mike" style="width:100% ">
      <div class="container">
        <h2>Official</h2>
        <p class="title">Suit</p>
        <p>Riara</p>
        <p>lightblue</p>
        <p>Price: From Kshs 4000</p>
  ...
  <div class="column">
    <div class="card">
      <img src="kids61.jpg" alt="" style="width:100%">
      <div class="container">
        <h2>Casual</h2>
        <p class="title">Trouser</p>
        <p>Girls</p>
        <p>white</p>
...
<div class="center">
  ...
  <a href="collection.php" >2</a>
  <a href="collection.php">3</a>
...
<footer >
  ...
  <li><a class="log" href="signup.php">Signup</a></li>
    ...
    <li><a href="mailto:harrietsoita@gmail.com" class='fa fa-envelope' style='font-size:24px'></a>Email</li>
    ...
    <li><a href="https://www.instagram.com/missharry/" class="fa fa-instagram" style="font-size:24px"></a>Instagram</li>
