...
for (i = 0; i < coll.length; i++) {
  ...
  <div class="rightcolumn">
    <div class="card">
      ...
      <div ><img src="trouser1.jpg" alt="" style="width:50%"></div><br>
      <div><img src="image 402.jpg" alt="" style="width:50%"></div><br>
      <div><img src="image6.jpg" alt="" style="width:50%"></div><br>
      <div><img src="trouser 3.jpg" alt="" style="width:50%"></div><br>
